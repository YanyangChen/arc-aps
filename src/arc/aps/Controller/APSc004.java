...
@Controller
@Scope("session")
@ACFgFunction(id="APSF004")
@RequestMapping(value=APStMapping.APSF004)
public class APSc004 extends ACFaAppController {
	...
	String section_id = APStGlobal.APS_SECTION_ID;
	...
	@RequestMapping(value=APStMapping.APSF004_MAIN, method=RequestMethod.GET)
	...
	@RequestMapping(value=APStMapping.APSF004_SEARCH_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APStMapping.APSF004_GET_FORM_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APStMapping.APSF004_GET_PAYMENT_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@ACFgTransaction
	@RequestMapping(value=APStMapping.APSF004_SAVE_AJAX, method=RequestMethod.POST)
	@ResponseBody
    ...
    @RequestMapping(value=APStMapping.APSF004_GET_SUPPLIER_AJAX, method=RequestMethod.POST)
    @ResponseBody
