...
import arc.aps.Static.APStGlobal;
import arc.aps.Static.APStMapping;

@Controller
@Scope("session")
@ACFgFunction(id="APSF003")
@RequestMapping(value=APStMapping.APSF003)
public class APSc003 extends ACFaAppController {
	...
	private class Search extends ACFgSearch {
		public Search() {
			...
			setCustomSQL("select * from (select t1.process_date as process_date, t1.process_date as p_date, t1.section_id as section_id, t1.programme_no as programme_no,  " +
	                 ...
	                 "  and t1.section_id = '"+APStGlobal.APS_SECTION_ID+"')");			
	...
	@RequestMapping(value=APStMapping.APSF003_MAIN, method=RequestMethod.GET)
	public String main(ModelMap model) throws Exception {

		model.addAttribute("labourselect", labourTypeService.getAllEffLabourTypebySection(APStGlobal.APS_SECTION_ID));
	...
	@RequestMapping(value=APStMapping.APSF003_SEARCH_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APStMapping.APSF003_GET_FORM_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APStMapping.APSF003_GET_CONSUME_DTL_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@ACFgTransaction
	@RequestMapping(value=APStMapping.APSF003_SAVE_AJAX, method=RequestMethod.POST)
	@ResponseBody
    ...
    @RequestMapping(value=APStMapping.APSF003_GET_ARC_PROGRAMME_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APStMapping.APSF003_GET_LABOUR_TYPE_AJAX, method=RequestMethod.POST)
    @ResponseBody
    public ACFgResponseParameters getLabourType(@RequestBody ACFgRequestParameters param) throws Exception {
        ...
        System.out.println("APS get labour " + param.get("labour_type", String.class) + ' ' + input_date);
