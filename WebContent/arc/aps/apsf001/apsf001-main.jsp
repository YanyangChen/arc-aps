...
<div class="col-md-12 nopadding">
	...
	<acf:Region id="reg_div_list" type="list" title="PAYMENT REQUEST LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="apsf001-search.ajax" readonly="true" autoLoad="false">
...
<!--   <acf:Region id="reg_form" title="PAYMENT REQUEST LIST">-->
		...
		<!-- 	<div class="col-xs-12 form-padding oneline">
     	...
     	-->	
			<div class="hidden"> 	
  			...
  			<div class="hidden"> 	
	 			<!--  	<div class="col-xs-12 form-padding oneline">  Print Indicator for online print Payment Request -->
     			<label class="control-label col-md-2" for="print_indicator">Print Indicator for online printing</label>
      			<div class="col-md-4">
      				<acf:TextBox id="print_indicator" name="print_indicator"/>
      			</div>
 			</div>     	
			   		...
			   		<acf:Bind on="change"><script>
   						...
   						if (supplier_code == ""){
	   						...
	   						$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/aps/apsf001/apsf001-aps-get-supplier-name.ajax",
								data   : JSON.stringify({
      			...
      			<acf:DateTimePicker id="despatch_date" name="despatch_date" pickDate="true" pickTime="false" displayformat="YYYY/MM/DD" checkMandatory="false">
			   			<acf:Bind on="validate"><script>
			   			    ...
			   			    if (ts != "-2209017600000" && ts < $("#request_date").getValue()) { 
			   					...
			   					$(this).setError(ACF.getQtipHint("APS001E"), "APS001E");
	...
	<acf:Region id="payment_details" title="PAYMENT DETAILS" type="list">			
		<div class="col-md-12">
			<acf:Grid id="grid_paymentdetails" url="apsf001-get-paymentdetails-table.ajax" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
				...
				<acf:Bind on='click' target="button"><script>
		   		    		...
		   		    		Dialog.create()
								...
								$.ajax({ //to get business platform desc 
									...
									async  : false,
									type   : "POST",
									url    : "${ctx}/arc/aps/aps-businessplatform-desc.ajax",
									data   : JSON.stringify({
	   			...
	   			<acf:Bind target="textBox" on="change"><script>
						...
						if(input.newValue!=null && $.trim(input.newValue).length==9) {
							$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/aps/aps-programme-fields.ajax",
								data   : JSON.stringify({
					...
					<acf:Bind on="validate"><script>
				    	...
				    	if(row.programme_name == null || row.programme_name == ""){
					    	return ACF.getQtipHint("APS002E");
					    }
				    }
					</script></acf:Bind>
				...
				<acf:Column name="particulars"   caption="Particulars" width="150" editable="true" maxlength="30"></acf:Column>
 				...
 				<acf:Column name="payment_amount"   caption="Amount " width="100" align= "right" editable="true" checkMandatory="true" align="right">
					...
					if(!$.isNumeric(row.payment_amount) || Number(row.payment_amount) == 0){
						return ACF.getQtipHint("APS003E");
					}
					}
					</script>
					</acf:Bind>
...
Controller.setOption({
    ...
    getUrl: "apsf001-get-form.ajax",
	saveUrl: "apsf001-save.ajax",
...
$(document).on('new', function() {
	...
	$("#frm_main #dds_code").setValue("2203");
	...
	$("#frm_main #no_of_times_printed").disable();
	$("#frm_main #section_id").setValue("01");
	$("#frm_main #print_indicator").setValue("0");
