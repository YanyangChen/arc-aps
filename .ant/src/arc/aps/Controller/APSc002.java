...
// import arc.apf.Static.APStMapping;

// @Controller
// @Scope("session")
// @ACFgFunction(id="APSF002")
// @RequestMapping(value=APStMapping.APSF002)
// public class APSc002 extends ACFaAppController {
// 
// 	@RequestMapping(value=APStMapping.APSF002_MAIN, method=RequestMethod.GET)
...
public class APSc002 extends ACFaAppController {
        ...
        public Search() {
          ...
          //SQL to combine two tables to form one grid in browser function
            setCustomSQL("select * from (select pr.payment_form_no, pr.request_date, pr.section_id, pr.request_department, pr.supplier_code, pr.despatch_date, pr.remarks, sp.supplier_name " +
                    ...
                    + "and (pr.section_id = '01') and (sp.supplier_code = 'CASH')) ");
 ...
 //      model.addAttribute("getsuppliercode", supplierService.getSupplierPairs());  only 'CASH' can be selected     
    ...
    @RequestMapping(value=APStMapping.APSF002_SEARCH_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APStMapping.APSF002_GET_SUPPLIER_NAME_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APStMapping.APSF002_GET_PAYMENTDETAILS_TABLE_AJAX, method=RequestMethod.POST) //get rows of the second grid
    @ResponseBody
    public ACFgResponseParameters getPaymentDetailsTable(@RequestBody ACFgRequestParameters param) throws Exception {
     ...
     @RequestMapping(value=APStMapping.APSF002_GET_FORM_AJAX, method=RequestMethod.POST)
        @ResponseBody
     ...
     @ACFgTransaction
        @RequestMapping(value=APStMapping.APSF002_SAVE_AJAX, method=RequestMethod.POST)
        @ResponseBody
