...
@Scope("session")
@ACFgFunction(id="")
@RequestMapping(value=APStMapping.APS) 
public class APSc extends ACFaAppController {
    ...
    public APSc() throws Exception {
        super();
    }
    
     
    
    @RequestMapping(value=APStMapping.APS_PAYMENTDETAILS_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APStMapping.APS_PROGRAMME_FIELDS_AJAX, method=RequestMethod.POST)
    @ResponseBody
...
//    
    @RequestMapping(value=APStMapping.APS_BUSINESSPLATFORM_DESC_AJAX, method=RequestMethod.POST)
    @ResponseBody
