...
<acf:Region id="reg_list" title="LABOUR CONSUMPTION LIST" type="form">
	<div class="widget-main no-padding">
		<div class="col-md-12 form-padding">
			<acf:Grid id="grid_browse" url="apsf003-search.ajax" readonly="true">
...
<form id="frm_main" class="form-horizontal" data-role="form" >
	...
	<acf:Region id="reg_form" title="LABOUR CONSUMPTION MAINTENANCE OF SETTING">
		<div class="form-group">		
	      			...
	      			<acf:TextBox id="programme_no" name="programme_no" button="fa-search" maxlength="9" checkMandatory="true" allowKey="[tT0-9]" forceCase="upper" format="(T[0-9]{8}|[0-9]{1,9})"> 
	      				<acf:Bind target="button" on="click"><script>
   						...
   						if ($.trim(programme_no) != ""){ 
	   						$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "apsf003-get-arc-programme.ajax",
								data   : JSON.stringify({
	   				...
	   				<acf:Bind on="validate"><script>
				    	...
				    	if($("#frm_main #transfer_status"),getValue() == 'I'){
					    	return ACF.getQtipHint("APF003V");
					    }
				    }
					</script></acf:Bind>	
	      			</acf:TextBox>	
		...
		<div class="hidden">
			<input id="section_id" name="section_id" value="01"/>
	...
	<acf:Region id="consumption_details" title="LABOUR CONSUMPTION DETAILS" type="form">	
		...
		<div class="col-md-12">			
			<acf:Grid id="grid_consume_dtl" url="apsf003-get-consume-dtl.ajax" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
					...
					<acf:Bind on="validate"><script>
						function validation (newValue, oldValue, newData, oldData, id) {
							...
							$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "apsf003-get-labour-type.ajax",
								data   : JSON.stringify({
...
Controller.setOption({
	...
	getUrl: "apsf003-get-form.ajax",
	saveUrl: "apsf003-save.ajax",
